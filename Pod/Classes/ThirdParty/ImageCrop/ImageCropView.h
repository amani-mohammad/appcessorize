...
@interface ImageCropViewController : UIViewController  <UIActionSheetDelegate, BottomConfirmViewDelegate> {
    ImageCropView * cropView;
    UIActionSheet * actionSheet;
}
@property (nonatomic, strong) id<ImageCropViewControllerDelegate> delegate;
